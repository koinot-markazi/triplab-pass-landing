...
export const OperatorListSection = (): JSX.Element => {
    ...
    return (
        <section className="w-full flex flex-col items-center pb-4">
            <div
                className="flex h-auto lg:h-[480px] w-full relative flex-col items-center gap-6 px-4 lg:px-[220px] py-16 lg:py-20">
            ...
            <footer
                className="flex h-auto lg:h-[383px] w-full relative flex-col items-center gap-12 lg:gap-20 px-4 lg:px-[220px] py-16 lg:py-20">
                ...
                <div className="flex flex-col items-center gap-8 relative self-stretch w-full flex-[0_0_auto]">
                    ...
                    <div
                        className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-4 lg:gap-0 relative self-stretch w-full flex-[0_0_auto]">
                        <div
                            className="relative w-fit mt-[-1.00px] [font-family:'SF_Pro-Regular',Helvetica] font-normal text-[#ffffff8f] text-sm tracking-[0] leading-[21px] whitespace-nowrap">
                            {t('footer.copyright')}
                        </div>
