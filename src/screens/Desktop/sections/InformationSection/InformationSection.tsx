  ...
  const infoCards = [
    {
      ...
      backgroundElements: (
        <div className="absolute top-[calc(50.00%_-_670px)] left-[calc(50.00%_-_499px)] w-[474px] h-[474px] rotate-[30deg]">
  ...
  return (
    <section className="relative w-full min-h-screen bg-[url(/image-2.png)] bg-cover bg-bottom">
      <div className="container mx-auto px-4 lg:px-0">
        <nav className="hidden lg:flex items-center justify-center gap-6 pt-7 pb-4">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          <Badge className="inline-flex items-center justify-center gap-[10.01px] px-[16.02px] py-[12.01px] bg-[#e9ff43] rounded-[46.05px] rotate-[-3.99deg] mb-8 h-auto">
            <div className="[font-family:'Inter',Helvetica] font-bold text-[#212121] text-2xl text-center tracking-[0] leading-[24.0px] whitespace-nowrap">
              {t('hero.badge')}
            </div>
          </Badge>

          <div className="max-w-[762px] mb-8">
            ...
            <div className="max-w-[490px] mx-auto [font-family:'SF_Pro-Regular',Helvetica] font-normal text-transparent text-2xl text-center tracking-[0] leading-[28.8px]">
          ...
          <Button className="inline-flex bg-white shadow-medium items-center justify-center gap-2.5 px-4 py-3 rounded-[46px] h-auto hover:bg-gray-50 transition-colors">
        ...
        <div className="text-center mb-16">
          ...
          <div className="[font-family:'SF_Pro-Regular',Helvetica] font-normal text-transparent text-2xl text-center tracking-[0] leading-9">
            ...
            >
              <CardContent className="p-0 relative h-full">
                ...
                <div className="flex flex-col w-[272px] items-start gap-3.5 relative top-6 left-6 z-10">
                  ...
                  <div className="[font-family:'SF_Pro-Regular',Helvetica] font-normal text-[#212121] text-base tracking-[0] leading-[22.4px]">
                    {card.content}
                  </div>
                </div>
              </CardContent>
